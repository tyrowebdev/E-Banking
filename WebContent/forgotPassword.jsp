	...
	<div class="main_body">
		<div class="login_form container" align="center">
			<form action="ForgotPassServ" method="post">
				...
				<p style="background-color: blue;color: white;">Enter Your Registered E-mail</p>
				<input type="text" placeholder="Registered E-mail" name="email" required="required"> 
				<input type="submit" value="Get Password" id="submit">
			</form>
		</div>
	</div>
