	...
	<div class="main_body">
		<div class="login_form container" align="center">
			<form action="TransferServ" method="post">
				...
				<div style="border: 2px white solid; margin-bottom: 5px;">Current Balance<input type="text" value="${bal.balance}" name ="old_bal" readonly="readonly"></div>
				<div style="border: 2px white solid;margin-bottom: 5px;">Your Account Number<input type="text" placeholder="Account Number" name="acs" value="${user.ac}" readonly="readonly"></div>
				<div style="border: 2px white solid;margin-bottom: 5px;">Receiver's Account Number<input type="text" placeholder="Receiver's Account Number" name="acr" required="required"></div>
				<div style="border: 2px white solid;margin-bottom: 5px;">Amount<input type="text" placeholder="Amount" name="amount" required="required"></div>
