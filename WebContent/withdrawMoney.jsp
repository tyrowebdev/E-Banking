	...
	<div class="main_body">
		<div class="login_form container" align="center">
			<form action="WithdrawServ" method="post">
				...
				<div style="border: 2px white solid; margin-bottom: 5px;">Current Balance<input type="text" value="${bal.balance}" name ="old_bal" placeholder="0.00" readonly="readonly"></div>
